...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory implements AutowireCapableBeanFactory {
    ...
    protected Object createBean(String beanName, BeanDefinition beanDefinition) throws BeansException{
        ...
        Object bean = resoleBeforeInstantiation(beanName, beanDefinition);
        if(bean != null){
            return bean;
        }
     ...
     * @return
     */
    protected Object resoleBeforeInstantiation(String beanName, BeanDefinition beanDefinition){
    ...
    /**
     * 在设置bean属性之前允许BeanPostProcessor修改属性值
     * @param beanName
     * @param bean
     * @param beanDefinition
     */
    protected void applyBeanPostProcessorsBeforeApplyingPropertyValues(String beanName, Object bean, BeanDefinition beanDefinition){
        for(BeanPostProcessor beanPostProcessor : getBeanPostProcessors()){
            if(beanPostProcessor instanceof InstantiationAwareBeanPostProcessor){
                ...
                if(pvs != null){
                    for(PropertyValue propertyValue : pvs.getPropertiesValues()){
